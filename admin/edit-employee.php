...
if (isset($_GET['emp_id']) && $_GET['emp_id'] != '') {
    ...
    $emp_data = mysql_query("SELECT * FROM `employee` WHERE `emp_id`='$emp_id'");
    $emp_data_row = mysql_fetch_assoc($emp_data);
//    var_dump($emp_data_row);
    if (!empty($emp_data_row)) {
        ?>
        <!DOCTYPE html>
        <html lang="en">
            <head>
                                ...
                                <div class="box col-md-12">
                                    <div class="box-inner">
                                        ...
                                        <div class="box-content">
                                            <form role="form" action="edit-employee-bc.php" method="post">
                                                <input type="hidden" name="emp_id" value="<?php echo $emp_data_row['emp_id']; ?>"/>
                                                <div class="form-group">
                                                    <label for="inputName">Full Name</label>
                                                    <input type="text" class="form-control" id="inputName" name="emp_name" value="<?php echo $emp_data_row['emp_name']; ?>" placeholder="Enter Full Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputSalary">Salary</label>
                                                    <input type="text" class="form-control" id="exampleInputPassword1" name="emp_sal" value="<?php echo $emp_data_row['emp_sal']; ?>" placeholder="Enter Salary">
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label" for="selectDepartment">Department Name</label>

                                                    <select id="selectDepartment" class="form-control" name="dept_id">
                                                        <?php
                                                        $departments = mysql_query("SELECT * FROM `department`");
                                                        while ($department = mysql_fetch_array($departments)) {
                                                            ?>
                                                        <option value="<?php echo $department['dept_id'] ?>" <?php echo ($emp_data_row['dept_id'] == $department['dept_id'] ? 'selected':'' ); ?>><?php echo $department['dept_name']; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
