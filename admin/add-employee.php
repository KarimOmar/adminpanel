                        ...
                        <div class="box col-md-12">
                            <div class="box-inner">
                                ...
                                <div class="box-content">
                                    <form role="form" action="add-employee-bc.php" method="post">
                                        <div class="form-group">
                                            <label for="inputName">Full Name</label>
                                            <input type="text" class="form-control" id="inputName" name="emp_name" placeholder="Enter Full Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputSalary">Salary</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1" name="emp_sal" placeholder="Enter Salary">
                                        </div>
