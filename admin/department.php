                            ...
                            <div class="box-inner">
                                <div class="box-header well" data-original-title="">
                                    ...
                                    <div class="box-icon">
                                        ...
                                        <a href="add-dept.php" class="btn btn-round btn-default"><i class="glyphicon glyphicon-plus"></i></a>
                                    </div>
                                </div>
                                <div class="box-content">
                                    ...
                                    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                        ...
                                        <tbody>
                                            <?php
                                            $deps = mysql_query("SELECT dept_id , dept_name FROM `department`");
                                            while ($dep = mysql_fetch_array($deps)) {
                                                ?> 
                                                <tr>
                                                    <td><?php echo $dep['dept_id']; ?> </td>
                                                    <td class="center"><?php echo $dep['dept_name']; ?> </td>
                                                    <td class="center">
